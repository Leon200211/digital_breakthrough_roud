...
use engine\main\userProfile\models\MainModel;


/**
 * Class UserProfileController абстрактный контроллер для работы с профилем
 * @package engine\main\userProfile\Controllers
 */
abstract class UserProfileController extends BaseController
{
